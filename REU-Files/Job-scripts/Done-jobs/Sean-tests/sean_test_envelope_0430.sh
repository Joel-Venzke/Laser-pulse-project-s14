...
TEST_DESCRIPTION=1.0676d-1-Env-test-0430
...
# copy and create input files
	...
	python $CODE_DIR/input_generator.py --ee1=1.0676d-1 --ww1=0.430d0 --n1up=2 --n1plat=36 --n1down=2 --s1up=\'$p1\' --s1down=\'$p2\' > pulse.inp
