...
TEST_DESCRIPTION=1.0676d-1-Onoff-asm-test-0350
COMPILED_CODE=work15b-all

# rerunning jobs that didn't finish
...
# copy and create input files
	...
	python $CODE_DIR/input_generator.py --ee1=1.0676d-1 --ww1=0.350d0 --n1up=$p1 --n1plat=$plat --n1down=$p1 --s1up=\'$p2\' --s1down=\'$p3\' > pulse.inp
