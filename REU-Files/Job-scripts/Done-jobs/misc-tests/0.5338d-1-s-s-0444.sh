...
TEST_DESCRIPTION=0.5338d-1-s-s-0444
...
# copy and create input files
	...
	python $CODE_DIR/input_generator.py --ee1=0.5338d-1 --ww1=0.444d0 --n1up=$p1 --n1plat=$plat --n1down=$p1 --s1up=\'$p2\' --s1down=\'$p2\' > pulse.inp
