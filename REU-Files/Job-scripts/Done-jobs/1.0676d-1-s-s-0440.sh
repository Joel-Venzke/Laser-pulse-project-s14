...
TEST_DESCRIPTION=1.0676d-1-s-s-0440
...
# copy and create input files
	...
	python $CODE_DIR/input_generator.py --ee1=1.0676d-1 --ww1=0.440d0 --n1up=$p1 --n1plat=$plat --n1down=$p1 --s1up=\'$p2\' --s1down=\'$p2\' > pulse.inp
