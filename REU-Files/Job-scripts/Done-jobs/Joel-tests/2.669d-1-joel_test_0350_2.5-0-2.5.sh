...
TEST_DESCRIPTION=2.669d-1_0350
...
NUMERICS_INPUT_FP=$CODE_DIR_FP/Input-files/tdse-shortcycle.inp
...
# copy and create input files
	...
	python2.6 $INP_FILE_GEN_FP --ee1=2.669d-1 --ww1=0.350d0 --n1up=$p1 --n1plat=$plat --n1down=$p1 --s1up=\'$p2\' --s1down=\'$p2\' > pulse.inp
