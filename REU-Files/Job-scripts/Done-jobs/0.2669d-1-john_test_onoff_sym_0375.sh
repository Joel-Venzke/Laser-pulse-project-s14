...
TEST_DESCRIPTION=0.2669d-1-Onoff-sym-test-0375
...
# copy and create input files
	...
	python $CODE_DIR/input_generator.py --ee1=0.2669d-1 --ww1=0.375d0 --n1up=$p1 --n1plat=$plat --n1down=$p1 --s1up=\'$p2\' --s1down=\'$p2\' > pulse.inp
