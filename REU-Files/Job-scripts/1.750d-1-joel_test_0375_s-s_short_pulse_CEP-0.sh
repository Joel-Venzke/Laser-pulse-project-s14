...
TEST_DESCRIPTION=1.750d-1-joel_test_0375_short_pulse_CEP-0
...
# copy and create input files
	...
	python2.6 $INP_FILE_GEN_FP --ee1=1.750d-1 --ww1=0.375d0 --x1up=$p1 --x1plat=$plat --x1down=$p1 --s1up=\'$p2\' --s1down=\'$p2\' > pulse.inp
