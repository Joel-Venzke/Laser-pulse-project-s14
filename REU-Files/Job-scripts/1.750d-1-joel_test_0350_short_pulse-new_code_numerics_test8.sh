...
TEST_DESCRIPTION=1.750d-1-joel_test_0350_short_pulse-new_code_numerics_test8
...
NUMERICS_INPUT_FP=$CODE_DIR_FP/Input-files/tdse-short_numerics-test-8_20141103.inp
